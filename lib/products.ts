...
export const products: Product[] = [
  ...
  },
  {
    ...
    leadImage: "/assets/processed/noir-trouser-front-clean.jpg",
    leadImagePosition: "center top",
    leadImageFit: "cover",
    cardImage: "/assets/processed/noir-trouser-front-clean.jpg",
    cardImagePosition: "center top",
    cardImageFit: "cover",
    gallery: [
      {
        src: "/assets/processed/noir-trouser-front-clean.jpg",
        alt: "Front view of the Noir Essential Trouser",
        fit: "cover",
        position: "center top",
      },
      {
        src: "/assets/processed/noir-trouser-back-legs-clean.jpg",
        alt: "Back legs of the Noir Essential Trouser showing ARYO signature embroidery on the back pocket",
        fit: "cover",
        position: "center top",
      },
      {
        src: "/assets/processed/noir-embroidery-detail-correct.jpg",
        alt: "ARYO signature embroidery close-up detail",
        fit: "cover",
        position: "center center",
      },
    ],
  ...
  },
  {
    ...
    leadImage: "/assets/processed/ivory-trouser-front-clean.jpg",
    leadImagePosition: "center top",
    leadImageFit: "cover",
    cardImage: "/assets/processed/ivory-trouser-front-clean.jpg",
    cardImagePosition: "center top",
    cardImageFit: "cover",
    gallery: [
      {
        src: "/assets/processed/ivory-trouser-front-clean.jpg",
        alt: "Front view of the Ivory Essential Trouser",
        fit: "cover",
        position: "center top",
      },
      {
        src: "/assets/processed/ivory-trouser-back-legs-clean.jpg",
        alt: "Back legs of the Ivory Essential Trouser showing ARYO signature embroidery on the back pocket",
        fit: "cover",
        position: "center top",
      },
      {
        src: "/assets/generated/luma-pack/detail-ivory-embroidery.png",
        alt: "ARYO signature embroidery detail on the Ivory Essential Trouser",
        fit: "cover",
        position: "center center",
      },
    ],
